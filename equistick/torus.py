...
STARTS = {
    ...
    # Deterministic symmetric_scan(seed_for('T8_9'/'T9_10'), trials=250).
    # Starting polygons only, not certified equilateral results.
    8: (1.0, 0.9806599866098731, 0.6025576127680349, 0.47296065357665584),
    9: (1.0, 1.185650056662787, 1.2766980635178709, 0.47668969519301024),
}
